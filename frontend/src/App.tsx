...
import CampaignsPage from "@/pages/fieldops/CampaignsPage";
...
import FarmersPage from "@/pages/fieldops/FarmersPage";
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route element={<DashboardLayout />}>
              ...
              <Route path="/fieldops/farmers" element={<FarmersPage />} />
              <Route path="/fieldops/campaigns" element={<CampaignsPage />} />
