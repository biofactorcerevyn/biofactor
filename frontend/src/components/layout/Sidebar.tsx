...
const navItems: NavItem[] = [
  {
    ...
    department: 'executive',
      ...
      { label: 'Performance Report', path: '/sales/performance' },
      { label: 'Pipeline Report', path: '/sales/pipeline' },
      { label: 'Commission Statement', path: '/sales/commissions' },
      { label: 'Documents', path: '/sales/documents' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Production Volume', path: '/manufacturing/volume' },
      { label: 'QC Report', path: '/manufacturing/qc' },
      { label: 'Inventory Level', path: '/manufacturing/inventory' },
      { label: 'Documents', path: '/manufacturing/documents' },
      { label: 'Tasks', path: '/manufacturing/tasks' },
    ],
  },
  {
    label: 'Warehouse',
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Headcount & Turnover', path: '/hr/headcount' },
      { label: 'Recruitment Pipeline', path: '/hr/pipeline' },
      { label: 'Training Completion', path: '/hr/training' },
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Farmers', path: '/fieldops/farmers' },
      { label: 'Campaigns', path: '/fieldops/campaigns' },
    ],
  },
  {
    label: 'R&D',
    ...
    children: [
      ...
      { label: 'Project Timeline', path: '/rnd/projects' },
      { label: 'Experiment Results', path: '/rnd/experiments' },
      { label: 'Literature Review', path: '/rnd/literature' },
      { label: 'Documents', path: '/rnd/documents' },
      { label: 'Tasks', path: '/rnd/tasks' },
    ],
  },
  {
    label: 'Marketing',
    ...
    icon: ShoppingCart,
    children: [
      { label: 'Campaign ROI', path: '/marketing/roi' },
      { label: 'Field Agent Activity', path: '/marketing/fieldagents' },
      { label: 'Event Performance', path: '/marketing/events' },
      { label: 'Documents', path: '/marketing/documents' },
      { label: 'Tasks', path: '/marketing/tasks' },
    ],
  },
];
...
export const Sidebar: FC<SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  // Show administration items for any authenticated user (adjust this to your RBAC later)
  const showAdminItems = !!user;
